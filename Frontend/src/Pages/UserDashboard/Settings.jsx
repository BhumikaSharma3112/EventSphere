...
import { User, Phone, BookOpen, Upload, Camera } from 'lucide-react';
...
const Settings = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (updateProfile.fulfilled.match(res)) {
      ...
      setToastMsg('Profile credentials updated successfully.');
    } else {
      setToastType('error');
  ...
  return (
    <DashboardLayout>
      ...
      <div className="text-left mb-8">
        <h1 className="font-display font-semibold text-xl md:text-2xl text-luxury-dark mb-2">Profile Credentials</h1>
        <p className="text-xs text-luxury-muted">
          Modify your guest identity information and biography.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-6 pb-4 border-b border-luxury-beige">
            ...
            <div className="flex flex-col">
              <span className="text-xs font-semibold text-luxury-dark">Profile Picture</span>
          ...
          {/* Bio */}
          <div className="flex flex-col">
            <label className="text-[9px] tracking-widest uppercase font-semibold text-luxury-gold mb-1.5 pl-1">Biography / About You</label>
